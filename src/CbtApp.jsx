...
const course1 = [
  {
    question:
      "In which year did Nigeria return to a democratic system of governance, leading to the establishment of INEC?",
    options: {
      A: "1991",
      B: "1995",
      C: "1999",
  ...
  {
    question:
      "Who was the first political party named Nigeria National Democratic Party (NNDP) founded by?",
    options: {
      A: "Dr. Nnamdi Azikiwe",
      B: "Herbert Macaulay",
  ...
  {
    question:
      "The National Council of Nigeria and Cameroons (NCNC) was led by which prominent nationalist?",
    options: {
      A: "Herbert Macaulay",
      B: "Ahmadu Bello",
      C: "Dr. Nnamdi Azikiwe",
  ...
  {
    question:
      "The Northern People's Congress (NPC) was led by which of the following?",
    options: {
      A: "Dr. Nnamdi Azikiwe",
  ...
  {
    question:
      "Which political party that predated Nigeria's political independence was founded in 1938?",
    options: {
  ...
  {
    question:
      "The National Council of Nigeria and Cameroons (NCNC) was formed in which year?",
    options: {
      A: "1923",
      B: "1938",
      C: "1944",
  ...
  {
    question:
      "Which political party was formed by the amalgamation of smaller groups in 1951?",
    options: {
      A: "Nigeria National Democratic Party (NNDP)",
      B: "Nigeria Youth Democratic Party (NYDP)",
      C: "National Council of Nigeria and Cameroon (NCNC)",
  ...
  {
    question:
      "The Independent National Electoral Commission (INEC) was established to register political parties and conduct elections in which year?",
    options: {
      A: "1999",
      B: "1991",
      C: "1960",
  ...
  {
    question:
      "Who was the presidential candidate of the People's Democratic Party (PDP) that won the 1999 presidential election?",
    options: {
  ...
  {
    question:
      "Which of these was NOT a political party that existed between 1960 and 1966?",
    options: {
      A: "Action Group (AG)",
  ...
  {
    question:
      "According to the text, which political party was founded in 1951?",
    options: {
  ...
  {
    question:
      "The military coup of 1966 that truncated the First Republic was led by which Major?",
    options: {
  ...
  {
    question:
      "Dr. Nnamdi Azikiwe was the first President of the Federal Republic of Nigeria, while who was the first Prime Minister?",
    options: {
      A: "Chief Obafemi Awolowo",
      B: "Sir Ahmadu Bello",
  ...
  {
    question:
      "Which political party was led by Sir Ahmadu Bello, Chief Obafemi Awolowo and Dr. Nnamdi Azikiwe during the First Republic?",
    options: {
      A: "Action Group (AG)",
  ...
  {
    question:
      "The National Council of Nigeria and Cameroon (NCNC) was changed to National Council of Nigerian Citizens (NCNC) in which year?",
    options: {
      A: "1951",
      B: "1955",
      C: "1960",
  ...
  {
    question:
      "The First Republic political parties existed between which years?",
    options: {
      A: "1951 and 1960",
      B: "1960 and 1966",
      C: "1966 and 1979",
  ...
  {
    question:
      "Which of these was a major political party in the Second Republic (1979-1983)?",
    options: {
  ...
  {
    question:
      "Who became the President of Nigeria in the Second Republic, following the country's adoption of the Presidential system of government?",
    options: {
  ...
  {
    question:
      "How many main political parties dominated Nigeria's political space in the Second Republic?",
    options: {
      A: "Two",
      B: "Four",
      C: "Five",
  ...
  {
    question:
      "The military coup that ended the Second Republic on December 31, 1983, was executed by who?",
    options: {
  ...
  {
    question:
      "Which two political parties did General Ibrahim Badamosi Babangida establish for the Third Republic?",
    options: {
  ...
  {
    question:
      "When did General Ibrahim Babangida establish the two political parties for the Third Republic?",
    options: {
      A: "1983",
      B: "1985",
      C: "1992",
  ...
  {
    question:
      "Which party from the list of Second Republic parties was led by Alhaji Shehu Shagari?",
    options: {
  ...
  {
    question:
      "The Third Republic was a transition program that was supposed to last until when?",
    options: {
      A: "1990",
      B: "1991",
      C: "1992",
  ...
  {
    question:
      "What was the name of the electoral procedure used for the 1993 general elections?",
    options: {
      A: "Option B5",
      B: "Option A4",
      C: "Option C2",
  ...
  {
    question:
      "Who was the chairman of the National Electoral Commission of Nigeria (NEC) that introduced the Option A4 voting system?",
    options: {
  ...
  {
    question:
      "The Option A4 voting system was considered the fairest in the political history of Nigeria because it allowed voters to do what?",
    options: {
  ...
  {
    question:
      "The Third Republic is described as the most unsuccessful attempt at restoring democracy because of what?",
    options: {
  ...
  {
    question:
      "In the Third Republic, what was the mixture of governance structure?",
    options: {
  ...
  {
    question:
      "General Babangida's promise to end the Military rule in 1990 was constantly 'reneged' in order to do what?",
    options: {
  ...
  {
    question:
      "According to the text, what was the name of M.K.O. Abiola's running mate in the 1993 presidential election?",
    options: {
  ...
  {
    question:
      "The two-party system was aimed at doing all the following except:",
    options: {
  ...
  {
    question:
      "In the Third Republic, what was the main political goal that General Babangida failed to achieve?",
    options: {
  ...
  {
    question:
      "As of December 2014, how many registered political parties are listed in the provided text?",
    options: {
      A: "20",
      B: "26",
      C: "30",
  ...
  {
    question:
      "Which of the following parties is NOT on the list of registered parties as of December 2014?",
    options: {
  ...
  {
    question:
      "The text mentions a flurry of activities in the registration of political parties in Nigeria towards which year's general elections?",
    options: {
      A: "2011",
      B: "2015",
      C: "2019",
  ...
  {
    question:
      "Which political party had its presidential candidate, Gen Muhammadu Buhari, win the 2015 general election?",
    options: {
  ...
  {
    question:
      "The win of Gen Muhammadu Buhari in 2015 broke the monopoly of which party as the government at the center?",
    options: {
      A: "All Progressives Congress (APC)",
  ...
  {
    question:
      "Which disease became widespread in Biafra due to famine during the war?",
    options: {
      A: "Malaria",
      B: "Kwashiorkor",
      C: "Cholera",
  ...
  {
    question:
      "What international organization emerged partly due to the humanitarian crisis in Biafra?",
    options: {
  ...
  {
    question:
      "Which political parties formed a temporary alliance after the Kano Riot?",
    options: {
      A: "AG and NPC",
      B: "NCNC and AG",
      C: "NPC and NCNC",
  ...
  {
    question:
      "The Kano Riot exposed the need for Nigeria to adopt what principle?",
    options: {
  ...
  {
    question:
      "Which military ruler overthrew Chief Ernest Shonekan's interim government in 1993?",
    options: {
      A: "General Ibrahim Babangida",
  ...
  {
    question:
      "What was the charge against MKO Abiola after his declaration as President in 1994?",
    options: {
      A: "Corruption",
      B: "Treason",
      C: "Electoral fraud",
  ...
  {
    question:
      "Which of these parties was NOT among the original three in Nigeria's 4th Republic (1999)?",
    options: {
  ...
  {
    question:
      "Which parties merged to form the All Progressives Congress (APC) in 2015?",
    options: {
      A: "PDP, ANPP, and AD",
  ...
  {
    question:
      "Why did Northern politicians reject the 1956 independence motion?",
    options: {
  ...
  {
    question:
      "Which Northern leader proposed 'independence as soon as practicable'?",
    options: {
      A: "Tafawa Balewa",
  ...
  {
    question:
      "How did Southern politicians protest the Northern counter-motion?",
    options: {
      A: "Armed rebellion",
  ...
  {
    question:
      "Which of the following is NOT a principle of good governance according to the text?",
    options: {
      A: "Accountability",
      B: "Transparency",
      C: "Nepotism",
  ...
  {
    question:
      "Which principle ensures citizens' access to information about government activities?",
    options: {
  ...
  {
    question:
      "What is described as 'the hallmark of good governance' in the text?",
    options: {
      A: "Transparency",
      B: "Accountability",
      C: "Rule of Law",
  ...
  {
    question:
      "Which of these is a prerequisite for protecting human rights and checking abuse of power?",
    options: {
  ...
  {
    question:
      "According to Igbo belief, which component represents 'destiny' in a person?",
    options: {
      A: "Aru (body)",
      B: "Chi (spirit)",
      C: "Mkpulubi (soul)",
  ...
  {
    question:
      "According to the text, what is essential for achieving social order and peace?",
    options: {
      A: "Strict laws",
  ...
  {
    question:
      "Which of these is NOT mentioned as a way to show respect in the text?",
    options: {
  ...
  {
    question:
      "What value is highly celebrated by Nigerians according to Igboin (2011)?",
    options: {
      A: "Wealth",
      B: "Hard work",
      C: "Political power",
  ...
  {
    question:
      "Which of these is NOT listed as a value affecting Nigeria's social system?",
    options: {
      A: "Political values",
      B: "Aesthetic values",
  ...
  {
    question:
      "According to the World Bank (1992), what is NOT a pillar of good governance?",
    options: {
  ...
  {
    question:
      "Which of these is a key feature of good governance as described in the text?",
    options: {
  ...
  {
    question:
      "Which principle ensures that government policies are implemented effectively?",
    options: {
      A: "Nepotism",
      B: "Efficiency",
      C: "Tribalism",
  ...
  {
    question:
      "Which regions in Nigeria are predominantly Christian and Muslim?",
    options: {
  ...
  {
    question:
      "What has reduced the influence of African Traditional Religion (ATR) in Nigeria?",
    options: {
      A: "Tribalism",
  ...
  {
    question:
      "Which vegetation zone do the northern Yoruba of Kwara and Kogi states belong to?",
    options: {
      A: "Mangrove",
      B: "Guinea Savannah",
      C: "Sahel Savannah",
  ...
  {
    question:
      "Which geopolitical zone is coterminous with the Guinea Savannah in Nigeria?",
    options: {
      A: "North-East",
      B: "South-East",
      C: "North-Central",
  ...
  {
    question:
      "Which ethnic group is associated with Benue state in the Guinea Savannah?",
    options: {
      A: "Nupe",
      B: "Tiv",
      C: "Bariba",
  ...
  {
    question:
      "Which of the following ethnic groups is NOT mentioned as being in the Guinea Savannah zone?",
    options: {
      A: "Bariga",
      B: "Kamuku",
      C: "Gwari",
  ...
  {
    question:
      "Which states are part of the Sudan/Sahel Savannah zone in Nigeria?",
    options: {
  ...
  {
    question:
      "Which ethnic groups are found in the Sudan/Sahel zone apart from Hausa and Fulani?",
    options: {
      A: "Yoruba and Igbo",
      B: "Ijaw and Ibibio",
  ...
  {
    question:
      "How many traditional Hausa kingdoms existed according to Hausa tradition?",
    options: {
      A: "5",
      B: "7",
      C: "9",
  ...
  {
    question:
      "Which of the following is NOT one of the original Hausa kingdoms (Bakwai)?",
    options: {
      A: "Daura",
      B: "Zaria",
      C: "Ilorin",
  ...
  {
    question:
      "Which of these is NOT a cause of systemic disenfranchisement in Nigerian elections?",
    options: {
  ...
  {
    question:
      "What is a major consequence of electoral violence during elections?",
    options: {
  ...
  {
    question:
      "What tool is used for voter accreditation but may malfunction during elections?",
    options: {
      A: "Ballot boxes",
      B: "Smartcard Readers",
      C: "Manual registers",
  ...
  {
    question:
      "Which of these is NOT a form of corruption mentioned in the text?",
    options: {
  ...
  {
    question:
      "What is a wider perspective of corruption beyond financial misappropriation?",
    options: {
  ...
  {
    question:
      "What sector is mentioned as affected by examination malpractice?",
    options: {
      A: "Healthcare",
      B: "Education",
      C: "Agriculture",
  ...
  {
    question:
      "Which term describes Nigeria's corruption according to the text?",
    options: {
  ...
  {
    question:
      "Which ethnic group in the Guinea Savannah zone is known for a large population and spread?",
    options: {
      A: "Fulani",
      B: "Kanuri",
      C: "Hausa",
  ...
  {
    question:
      "Which ethnic group is found in both Niger and Kaduna states within the Guinea Savannah?",
    options: {
      A: "Yoruba",
      B: "Jukun",
      C: "Gwari",
  ...
  {
    question:
      "Which ethnic group is both nomadic and agricultural in the Sahel region?",
    options: {
      A: "Igbo",
      B: "Yoruba",
      C: "Kanuri",
  ...
  {
    question:
      "What is the typical temperature range for Nigeria's eastern borderlands?",
    options: {
      A: "Below 20°C",
      B: "22°C – 24°C",
      C: "24°C – 27°C",
  ...
  {
    question:
      "Humidity levels in Sokoto/Katsina and Bauchi/Gombe interiors are typically:",
    options: {
      A: "80–100%",
      B: "60–80%",
      C: "20–40%",
  ...
  {
    question:
      "The entire country of Nigeria experiences humidity levels ranging from:",
    options: {
      A: "0% to 20%",
      B: "20% to 80%",
      C: "40% to 90%",
  ...
  {
    question:
      "From the Atlantic Ocean in the south to the Sahara desert in the north, Nigeria’s vegetation transitions through:",
    options: {
  ...
  {
    question:
      "Which vegetation zone lies immediately north of the mangrove belt?",
    options: {
      A: "Sahara Desert",
      B: "Rainforest",
      C: "Sahel Savannah",
  ...
  {
    question:
      "Which of the following is not a characteristic of Nigeria’s southern climate?",
    options: {
      A: "High rainfall",
      B: "Dense vegetation",
      C: "Low humidity",
  ...
  {
    question:
      "Which region is known to experience both dry and wet seasons due to alternating wind systems?",
    options: {
      A: "South-West",
      B: "North-East",
      C: "Entire country",
  ...
  {
    question:
      "Which region is moderately hot with temperatures between 24°C and 27°C?",
    options: {
      A: "Jos Plateau",
  ...
  {
    question:
      "How many ethnic nationalities does Nigeria have, according to the text?",
    options: {
      A: "Less than 50",
      B: "Over 200",
      C: "Exactly 100",
  ...
  {
    question:
      "Which of the following states is NOT part of the North-East geopolitical zone?",
    options: {
      A: "Adamawa",
      B: "Bauchi",
      C: "Kano",
  ...
  {
    question:
      "Which ethnic group is predominant in the South-East geopolitical zone?",
    options: {
      A: "Yoruba",
      B: "Igbo",
      C: "Hausa",
  ...
  {
    question:
      "What are the three broad ethnic population zones mentioned in the text?",
    options: {
  ...
  {
    question:
      "Which of the following ethnic groups is NOT mentioned as predominant in the North-Central geopolitical zone?",
    options: {
      A: "Yoruba",
      B: "Tiv",
      C: "Igbo",
  ...
  {
    question:
      "Which vegetation belts are associated with the southern geopolitical zones?",
    options: {
  ...
  {
    question:
      "Which of the following is a dominant ethnic group in the North-West and North-East zones?",
    options: {
      A: "Yoruba",
      B: "Igbo",
      C: "Hausa and Fulani",
  ...
  {
    question:
      "Which of the following is NOT a state in the South-South geopolitical zone?",
    options: {
      A: "Akwa-Ibom",
      B: "Bayelsa",
      C: "Enugu",
  ...
  {
    question:
      "Which ethnic groups are mentioned as the most widespread in Niger?",
    options: {
  ...
  {
    question:
      "Which of the following is NOT one of the historically dominant ethnic groups in Nigeria?",
    options: {
      A: "Hausa-Fulani",
      B: "Yoruba",
      C: "Igbo",
  ...
  {
    question:
      "What promoted greater intercourse between groups in the grasslands?",
    options: {
  ...
  {
    question:
      "Which of the following groups had trade and cultural contacts with the Hausa, Fulani, and Nupe?",
    options: {
  ...
  {
    question:
      "What was the significance of the resultant interdependence between ethnic groups under colonial rule?",
    options: {
  ...
  {
    question:
      "Which of the following is NOT mentioned as a second group of fairly large ethnic nationalities?",
    options: {
      A: "Jukun",
      B: "Tiv",
      C: "Bini",
  ...
  {
    question:
      "What was the primary reason for trade between coastal dwellers and agricultural people from the forest belt?",
    options: {
  ...
  {
    question:
      "Which of the following is a characteristic of the third group of ethnic groups mentioned?",
    options: {
  ...
  {
    question:
      "What was the impact of European contact on trade among ethnic groups?",
    options: {
  ...
  {
    question:
      "What is one of the cultural attributes cherished by the people, as mentioned in the text?",
    options: {
      A: "Good conduct",
  ...
  {
    question:
      "Which of the following is NOT an element of Nigerian hospitality?",
    options: {
      A: "Honesty",
      B: "Violence",
      C: "Warmness",
  ...
  {
    question:
      "What is the relationship between indigenes and settlers initially like?",
    options: {
  ...
  {
    question:
      "Which ancient civilisation is mentioned as dating back to 500 BC – 200 A.D.?",
    options: {
      A: "Ife",
      B: "Nok",
      C: "Benin",
  ...
  {
    question:
      "What is the primary cause of conflict between indigenes and settlers?",
    options: {
      A: "Religious differences",
  ...
  {
    question:
      "What is the consequence of the breakdown of peaceful relationships between indigenes and settlers?",
    options: {
  ...
  {
    question:
      "Which of the following is NOT a characteristic of hospitality in Nigerian culture?",
    options: {
  ...
  {
    question:
      "What is the main reason for the high moral standards in the past, as mentioned in the text?",
    options: {
  ...
  {
    question:
      "Who defined culture as 'a humanising process characterised by the collective effort to preserve life'?",
    options: {
      A: "E.B. Taylor",
      B: "Herbert Marcus",
      C: "Dioka",
  ...
  {
    question:
      "Which company drilled the first successful oil well at Oloibiri?",
    options: {
      A: "Elf",
      B: "Shell D'Arcy",
      C: "Texaco",
  ...
  {
    question:
      "Which oil company started operations in Nigeria in 1962 as Safrap?",
    options: {
      A: "Elf",
      B: "Mobil",
      C: "Texaco",
  ...
  {
    question:
      "When did the Department of Petroleum Resources Inspectorate start?",
    options: {
      A: "1968",
      B: "1970",
      C: "1971",
  ...
  {
    question:
      "What percentage of shares did the Federal Government acquire in oil companies?",
    options: {
      A: "25%",
      B: "30%",
      C: "35%",
  ...
  {
    question:
      "Pan Ocean Corporation drilled its first discovery well at which location?",
    options: {
      A: "Osari",
      B: "Obagi",
      C: "Ogharefe",
  ...
  {
    question:
      "According to Odili & Mokwunye (2003), what plays a major role in the economic transformation of a country?",
    options: {
  ...
  {
    question:
      "What is heavily dependent on the performance and growth of the power sector?",
    options: {
  ...
  {
    question:
      "What has been a phenomenal increase in the area of Trade and Commerce?",
    options: {
      A: "Telephone lines",
  ...
  {
    question:
      "By what year had the number of Nigerian internet users from the year 2001 increased largely?",
    options: {
      A: "2005",
      B: "2008",
      C: "2010",
  ...
  {
    question:
      "What has Nigeria integrated into its financial system, a step that has reduced the flow of physical cash?",
    options: {
  ...
  {
    question:
      "What has the whole world becoming as a result of the internet activities and sky-rocketed the effect of globalization?",
    options: {
      A: "More complex",
      B: "Smaller",
      C: "More isolated",
  ...
  {
    question:
      "What does the Nigerian Government, through the Ministry of Industry, Trade and Investment, seek to ensure?",
    options: {
  ...
  {
    question:
      "What has become pertinent for the Nigerian economy given its past sole dependency on oil exports?",
    options: {
  ...
  {
    question:
      "According to the text, what is education considered to be for human capital formation?",
    options: {
      A: "A burden",
  ...
  {
    question:
      "What is crucial and fundamentally linked to the educational system for a nation's ability to develop?",
    options: {
      A: "Economic status",
  ...
  {
    question:
      "What is the primary determinant of a country's standard of living?",
    options: {
  ...
  {
    question:
      "According to Ogbodo & Nwaoku (2007), what can be neglected only at a country's peril?",
    options: {
  ...
  {
    question:
      "What does education liberate man and his society from, according to Aghenta (2001)?",
    options: {
  ...
  {
    question:
      "Development on the other hand is a total and comprehensive transformation through quantitative and qualitative improvements in various parameters of life. What do investment theorists believe development begins with?",
    options: {
      A: "Financial capital",
  ...
  {
    question:
      "In which plan is the foundation for Nigerian educational policy found?",
    options: {
  ...
  {
    question:
      "What was the proposed goal of equal opportunity for all citizens in the Second National Development Plan?",
    options: {
  ...
  {
    question:
      "What was the proposed development plan that should foster the study of Nigerian culture and teach the importance of national unification?",
    options: {
  ...
  {
    question:
      "According to Taiwo (1980), what was given top priority by the government as a social service and investment in manpower?",
    options: {
      A: "Healthcare",
      B: "Education",
      C: "Agriculture",
  ...
  {
    question:
      "What traditional role does the agricultural sector play in the economic development of Nigeria?",
    options: {
  ...
  {
    question:
      "Since when has Nigeria been undertaking most public policies in agriculture to promote food security?",
    options: {
      A: "1950",
      B: "1960",
      C: "1966",
  ...
  {
    question:
      "What does the agricultural sector provide to alleviate poverty and earn substantial foreign exchange?",
    options: {
  ...
  {
    question:
      "According to Nneka (2017), what percentage of its Gross Domestic Product does the leading economic activity in the continent contribute?",
    options: {
  ...
  {
    question:
      "At independence in 1960, what was the main source of export earnings and public revenue?",
    options: {
      A: "Oil production",
  ...
  {
    question:
      "What company has taken over the leading role in the economy from the agricultural marketing boards?",
    options: {
  ...
  {
    question:
      "According to data from the Central Bank of Nigeria (2003), what percentage of the nation's revenue earnings and export earnings do oil accounts for?",
    options: {
      A: "Around 50%",
  ...
  {
    question:
      "Despite the significant contribution of oil, for what purpose do Nigerians indulge in agriculture?",
    options: {
  ...
  {
    question:
      "What are the two main categories of energy resources that electricity has brought about development in?",
    options: {
  ...
  {
    question:
      "Which of the following is NOT an example of a non-renewable energy source mentioned in the text?",
    options: {
      A: "Fuel oil",
      B: "Natural gas",
      C: "Coal",
  ...
  {
    question:
      "According to Patience (2006), what period saw remarkable development in water transportation in Nigeria?",
    options: {
  ...
  {
    question:
      "What improvements were introduced in water transportation during this period?",
    options: {
  ...
  {
    question:
      "Which river did the outboard engine boat (the Erico) operate on?",
    options: {
      A: "River Benue",
      B: "River Niger",
      C: "River Cross",
  ...
  {
    question:
      "When was the first Niger Bridge linking Asaba to Onitsha constructed?",
    options: {
      A: "1950s",
      B: "1960s",
      C: "1970s",
  ...
  {
    question:
      "What happened to the collection of tolls on the first Niger Bridge later?",
    options: {
      A: "It was increased",
      B: "It was abolished",
      C: "It was privatized",
  ...
  {
    question:
      "Which of these is NOT a major bridge across the River Niger and River Benue mentioned in the text?",
    options: {
      A: "Ajaokuta Bridge",
      B: "Makurdi Bridge",
      C: "Lokoja Bridge",
  ...
  {
    question:
      "What is considered one of the main features of the economic development of Nigeria, historically?",
    options: {
  ...
  {
    question:
      "According to Nneka (2017), what percentage of the population engaged in agriculture is between 24.4 and 85.1% across various geo-political zones in Nigeria?",
    options: {
      A: "Manufacturing",
      B: "Mining",
      C: "Agriculture",
  ...
  {
    question:
      "What is a characteristic of some nations that are highly industrialized?",
    options: {
  ...
  {
    question:
      "Which of the following is NOT mentioned as a major seaport in Nigeria?",
    options: {
      A: "Lagos port",
      B: "Port-Harcourt",
  ...
  {
    question:
      "The development of modern seaports in Nigeria was linked to the establishment of which body?",
    options: {
  ...
  {
    question:
      "In what year was the Nigerian Ports Authority (N.P.A) established?",
    options: {
      A: "1945/46",
      B: "1954/55",
      C: "1964/65",
  ...
  {
    question:
      "What did Nigerian ports play as a dominant role in the country's international trade?",
    options: {
      A: "A minor role",
  ...
  {
    question:
      "Which of the following was established in Lagos to alleviate port congestion in the 1970s?",
    options: {
      A: "A new airport",
  ...
  {
    question:
      "What unfavorable conditions did Nigerian ports continue to suffer from?",
    options: {
      A: "Modern facilities",
  ...
  {
    question:
      "What does the functioning of any economy require besides the use of transport?",
    options: {
  ...
  {
    question:
      "Why are transport infrastructure projects typically provided and subsidized by the government?",
    options: {
  ...
  {
    question:
      "What did inconsistencies in British policy reinforce, particularly regarding indigenous cultures?",
    options: {
      A: "National unity",
  ...
  {
    question:
      "What kind of rule did modern nationalists in the south, whose thinking was shaped by European ideas, oppose?",
    options: {
      A: "Direct rule",
      B: "Indirect rule",
      C: "Self-rule",
  ...
  {
    question:
      "According to Guntram & David (1989), what was considered to be an anachronistic ruling class in power and shut out?",
    options: {
  ...
  {
    question:
      "From what sources did the ideological inspiration for southern nationalists come?",
    options: {
  ...
  {
    question:
      "Which of the following Pan-African groups was formed in London by Nigerian students?",
    options: {
  ...
  {
    question:
      "In 1925, what did early nationalists tend to ignore regarding Nigeria?",
    options: {
  ...
  {
    question:
      "According to Tamuno & Atand (1989), what happened to Independent Christian churches?",
    options: {
  ...
  {
    question:
      "In the 1920s, what types of associations were ostensibly non-political?",
    options: {
  ...
  {
    question:
      "According to Ikelegbe (1996), what happened to the Head of State with the establishment of the Federation?",
    options: {
  ...
  {
    question:
      "What was the second change regarding the Republican Constitution?",
    options: {
  ...
  {
    question:
      "What significant change was introduced by the 1963 Republican Constitution regarding the President?",
    options: {
  ...
  {
    question:
      "Under the Republican Constitution, whom was the president empowered to appoint?",
    options: {
  ...
  {
    question:
      "What is the first phenomenon generally used to describe nationalism?",
    options: {
  ...
  {
    question:
      "What is the second phenomenon generally used to describe nationalism?",
    options: {
  ...
  {
    question:
      "According to Nwabuoghugu (2004), what does nationalism define as?",
    options: {
  ...
  {
    question:
      "What was one of the main features of the 1963 Republican Constitution?",
    options: {
  ...
  {
    question:
      "Who was the commander-in-chief of the armed forces under the 1963 Constitution?",
    options: {
  ...
  {
    question:
      "What was the reason for increasing the seats in the Senate and House of Representatives in 1963?",
    options: {
  ...
  {
    question:
      "What was a criticism of the 1963 Constitution regarding the judiciary?",
    options: {
  ...
  {
    question:
      "What was the highest court of appeal in Nigeria under the 1963 Constitution?",
    options: {
      A: "The Privy Council",
  ...
  {
    question:
      "When was the 1963 Republican Constitution passed into law in Nigeria?",
    options: {
      A: "July 25, 1963",
      B: "September 19, 1963",
      C: "October 1, 1963",
  ...
  {
    question:
      "Who ceased to be the head of state under the 1963 Republican Constitution?",
    options: {
  ...
  {
    question:
      "Which body became the highest court of appeal under the 1963 Constitution?",
    options: {
      A: "The Privy Council",
      B: "The Judicial Service Commission",
      C: "The Supreme Court",
  ...
  {
    question:
      "Who was vested with the power to appoint and promote judges under the 1963 Constitution?",
    options: {
      A: "The President",
      B: "The Supreme Court",
  ...
  {
    question:
      "What power was vested in the Supreme Court under the 1963 Constitution?",
    options: {
  ...
  {
    question:
      "Why were the seats in the Senate and House of Representatives increased in 1963?",
    options: {
      A: "To reduce the power of the President",
      B: "To accommodate the creation of the Mid-Western region",
      C: "To abolish the Privy Council",
  ...
  {
    question:
      "What was a major criticism of the 1963 Constitution regarding the election of the president?",
    options: {
  ...
  {
    question:
      "What was the highest court of appeal under the 1960 Independence Constitution?",
    options: {
  ...
  {
    question:
      "What was the role of the Judicial Service Commission under the 1960 Constitution?",
    options: {
      A: "To appoint the Prime Minister",
  ...
  {
    question:
      "What type of executive system did the 1960 Constitution provide?",
    options: {
  ...
  {
    question:
      "What was the consequence of the Northern delegates' opposition to independence?",
    options: {
  ...
  {
    question:
      "How many unofficial members were in the legislative council under the Richards Constitution?",
    options: {
      A: "16",
      B: "28",
      C: "46",
  ...
  {
    question:
      "Which regions had unicameral legislatures under the Richards Constitution?",
    options: {
      A: "North and West",
      B: "East and West",
      C: "North and East",
  ...
  {
    question:
      "What was the reduced franchise amount under the Richards Constitution?",
    options: {
      A: "100 pounds",
      B: "75 pounds",
      C: "50 pounds",
  ...
  {
    question:
      "Which two cities had elected members in the legislative council?",
    options: {
      A: "Lagos and Kano",
      B: "Calabar and Enugu",
      C: "Lagos and Calabar",
  ...
  {
    question:
      "What was the nature of regional houses of assembly under the Richards Constitution?",
    options: {
  ...
  {
    question:
      "What did the Clifford Constitution introduce for the first time in Nigeria?",
    options: {
      A: "Military rule",
  ...
  {
    question:
      "How many elected members were in the legislative council under the Clifford Constitution?",
    options: {
      A: "2",
      B: "4",
      C: "23",
  ...
  {
    question:
      "What was the minimum income requirement to vote under the Clifford Constitution?",
    options: {
      A: "50 pounds",
      B: "75 pounds",
      C: "100 pounds",
  ...
  {
    question:
      "Which areas could the legislative council legislate for under the Clifford Constitution?",
    options: {
      A: "The whole country",
      B: "Only the North",
      C: "Only the South",
  ...
  {
    question:
      "Who divided Nigeria into East, West and North for administrative purposes?",
    options: {
      A: "Sir Hugh Clifford",
      B: "Sir Arthur Richards",
  ...
  {
    question:
      "What replaced the Nigerian Council under the Clifford Constitution?",
    options: {
  ...
  {
    question:
      "What was the composition of the Legislative Council under the Clifford Constitution?",
    options: {
  ...
  {
    question:
      "What was the main criticism of the Clifford Constitution by educated elites?",
    options: {
  ...
  {
    question:
      "Who was responsible for overseeing the unification of Nigeria in 1914?",
    options: {
  ...
  {
    question:
      "Which British official strongly advocated for Nigeria's amalgamation?",
    options: {
  ...
  {
    question:
      "What was the financial situation of Northern Nigeria Protectorate before amalgamation?",
    options: {
      A: "Budget surplus",
      B: "Budget deficit",
  ...
  {
    question:
      "What position did Lugard hold when he first thought about merging Nigeria?",
    options: {
      A: "Governor-General",
  ...
  {
    question:
      "What was the financial situation of Southern Nigeria before amalgamation?",
    options: {
      A: "Budget deficit",
      B: "Budget surplus",
  ...
  {
    question:
      "Who was the Secretary of State for the Colonies during the amalgamation?",
    options: {
  ...
  {
    question:
      "What was the main challenge of governing Nigeria before amalgamation?",
    options: {
  ...
  {
    question:
      "Who recommended the division of Nigeria into 'Soudan' and 'Maritime' provinces?",
    options: {
      A: "Sir Frederick Lugard",
  ...
  {
    question:
      "What was one of the significant moments for British administration in Africa?",
    options: {
  ...
  {
    question:
      "What was the political status of Nigeria before British colonial rule?",
    options: {
      A: "A unified state",
  ...
  {
    question:
      "What was one of the sections in the chapter about Nigeria's evolution?",
    options: {
...
const course2 = [
  ...
  {
    question:
      "What triggered the collapse of the solar nebula according to scientists?",
    options: {
  ...
  {
    question:
      "What phenomenon occurs at the North Pole during winter solstice?",
    options: {
  ...
  {
    question:
      "Which scientist famously used imagination in developing relativity?",
    options: {
      A: "Newton",
      B: "Einstein",
      C: "Galileo",
  ...
  {
    question:
      "Which radiation type was discovered to contain positively charged particles?",
    options: {
      A: "Gamma radiation",
      B: "Beta radiation",
      C: "Alpha radiation",
  ...
  {
    question:
      "Which characteristic of Nigerian crude oil gives it a competitive advantage in global markets?",
    options: {
    ...
    answer: "B",
    explanation:
      "The text specifies Nigerian crude is 'light and sweet' (low density/sulfur), commanding better prices.",
  },
  {
    question:
      "During coal carbonization at 1000-3000°C, which by-product serves as the primary source of aromatic compounds?",
    options: {
      A: "Coal gas",
      B: "Ammoniacal liquor",
      C: "Coal tar",
    ...
    answer: "C",
    explanation:
      "Coal tar is described as containing 'mainly aromatic compounds' for fractional distillation.",
  },
  {
    question:
      "What is the critical limitation of hydrogen fuel production via steam reforming?",
    options: {
    ...
    answer: "B",
    explanation:
      "The text notes steam reforming of natural gas produces both hydrogen and CO2, undermining its clean energy potential.",
  },
  {
    question:
      "Which hazardous waste characteristic applies to sodium metal exposed to water?",
    options: {
      A: "Ignitability (D003)",
      B: "Corrosivity (D002)",
      C: "Reactivity (D003)",
    ...
    answer: "C",
    explanation:
      "Sodium metal is cited as reactive waste due to violent water reactions generating toxic gases.",
  },
  {
    question:
      "What distinguishes thermoplastics from thermosetting plastics at the molecular level?",
    options: {
    ...
    answer: "C",
    explanation:
      "Thermoplastics rely on weak van der Waals forces, allowing reshaping, unlike thermosets' covalent cross-links.",
  },
  {
    question:
      "Which radiation discovery demonstrated particles deflected by positive charges?",
    options: {
    ...
    answer: "D",
    explanation:
      "Marie Curie showed alpha particles were repelled by positive plates, indicating their positive charge.",
  },
  {
    question:
      "What is the primary environmental risk of mechanical beach raking for marine debris removal?",
    options: {
    ...
    answer: "B",
    explanation:
      "The text highlights damage to aquatic vegetation and nesting birds from habitat disturbance.",
  },
  {
    question:
      "Which nuclear fuel cycle stage poses the longest-term disposal challenge?",
    options: {
    ...
    answer: "D",
    explanation:
      "Spent fuel rods require 10,000 years to decay safely, making permanent storage technologically complex.",
  },
  {
    question:
      "What makes brominated flame retardants in plastics particularly hazardous?",
    options: {
    ...
    answer: "B",
    explanation:
      "These additives are noted as persistent, bioaccumulative toxins with carcinogenic potential.",
  },
  {
    question:
      "Which factor critically limits the sustainability of deep-well geothermal energy extraction?",
    options: {
    ...
    answer: "A",
    explanation:
      "The text implies finite magma heat sources may not be truly renewable on human timescales.",
  },
];
...
const course3 = [
  {
    question:
      "What is the impersonal, unchanging reality that Hindus believe to be in all things, also referred to as the 'Supreme Reality'?",
    options: {
      A: "Vishnu",
      B: "Shiva",
      C: "Bramah",
  ...
  {
    question:
      "According to the provided text, what is the ultimate Hindu ideal?",
    options: {
      A: "To worship many gods",
      B: "To achieve a permanent unchanging reality",
      C: "To find a single, personalized god",
      D: "To avoid the concept of impermanence",
    },
    answer: "B",
  },
  {
    question:
      "What is the Sanskrit term for the impersonal, unchanging reality?",
    options: {
      A: "Moksha",
      B: "Bramah",
      C: "Atman",
  ...
  {
    question:
      "The text states that Bramah is 'neuter'. What does this mean in the context of the reading?",
    options: {
      A: "It is a concept of being neither male nor female",
      B: "It is an outdated term",
      C: "It means the concept is without gender and is not a person",
      D: "It means the concept is both male and female",
    },
    answer: "C",
  },
  {
    question:
      "The text mentions that Hindus choose to devote themselves to deities. Why do they do this?",
    options: {
      A: "To appease the gods",
      B: "To find a personal connection to a single god",
      C: "To avoid the impersonal aspect of Bramah",
      D: "To get to Moksha",
    },
    answer: "B",
  },
  {
    question: "The text mentions 'Moksha' as liberation from what?",
    options: {
      A: "Sin and evil",
      B: "The cycle of impermanence and change",
  ...
  {
    question:
      "How do Hindus view the veneration of a particular aspect of a single reality?",
    options: {
      A: "As a sign of polytheism",
      B: "As a way to see the gods as windows into a single reality",
      C: "As a rejection of the impersonal god",
      D: "As a way to ignore the concept of Bramah",
    },
    answer: "B",
  },
  {
    question: "According to the provided text, what is the cause of evil?",
    options: {
      A: "Personal repentance",
      B: "A lack of natural beauty",
      C: "An act of evil spirits",
      D: "The belief in human beings as good",
    },
    answer: "C",
  },
  {
    question: "In Shinto belief, where does the cure for sin or evil lie?",
    options: {
      A: "In personal repentance",
      B: "In participation in the ceremonies of purification",
      C: "In an optimistic view of life",
      D: "In a final judgment",
    },
    answer: "B",
  },
  {
    question:
      "What is the Shinto belief about human beings and a final judgment?",
    options: {
      A: "There is a final judgment for all humans.",
      B: "The gods judge humans after death.",
      C: "There is no idea of final judgment, and humans are fundamentally good.",
      D: "Final judgment is based on the actions of evil spirits.",
    },
    answer: "C",
  },
  {
    question:
      "Which type of Shinto is most acknowledged and links ancient Shinto with the present day?",
    options: {
      A: "State Shinto",
      B: "Folk Shinto",
      C: "Shrine Shinto",
  ...
  {
    question: "What are 'Kami' in the context of Shrine Shinto?",
    options: {
      A: "The religious leaders of the Shinto faith",
      B: "The dwelling places for the gods",
      C: "The sacred texts of Shintoism",
      D: "The gods or spirits worshiped in Shinto",
    },
    answer: "D",
  },
  {
    question:
      "How many Shinto shrines were there in Japan according to statistics compiled in 1969?",
    options: {
      A: "Approximately 800",
      B: "Exactly 80,000",
      C: "Over 80,000",
  ...
  {
    question:
      "Which of the following describes the belief of optimism in Shinto?",
    options: {
      A: "The belief that man is a superior being",
      B: "The belief that everything is basically good and things will become better",
      C: "The belief that man is destined to be a blessing to others",
      D: "The belief that there is a world of light and a world of darkness",
    },
    answer: "B",
  },
  {
    question:
      "What does Shinto teach about the relationship between life and death?",
    options: {
      A: "Life and death are in radical opposition.",
      B: "Man continues living after death and receives blessings.",
      C: "The dead are judged and sent to a world of light or darkness.",
      D: "There is no existence after death.",
    },
    answer: "B",
  },
  {
    question:
      "The text states that the dead are believed to visit the world of light during which event?",
    options: {
      A: "Funerals",
      B: "Shintos festivals",
      C: "Purification ceremonies",
      D: "Everyday worship",
    },
    answer: "B",
  },
  {
    question: "What is Shinto's stance on ethical systems and moral codes?",
    options: {
      A: "It offers a strict ethical system and moral code.",
      B: "It emphasizes quietly living out one's way of life rather than offering a moral code.",
      C: "It teaches that ethical behavior is a cure for evil.",
      D: "It has no ethical system, which is a flaw.",
    },
    answer: "B",
  },
  {
    question:
      "According to the text, what is regarded as goodness, blessedness, and a beautiful thing?",
    options: {
      A: "To avoid all evil spirits.",
      B: "To say that evil is an act of personal repentance.",
      C: "To live a natural and harmonious life.",
      D: "To accept life as it is without optimism.",
    },
    answer: "C",
  },
  {
    question:
      "What is the name for the type of Shinto centered on rites for the imperial ancestors?",
    options: {
      A: "Sect Shinto",
      B: "Folk Shinto",
      C: "State Shinto",
      D: "Shinto of the Imperial House",
    },
    answer: "D",
  },
  {
    question:
      "What type of Shinto is described as a mixture of superstition, magic, and other common practices?",
    options: {
      A: "Folk Shinto",
      B: "Sect Shinto",
      C: "Shrine Shinto",
  ...
  {
    question: "When was Sect Shinto founded?",
    options: {
      A: "During the later years of the 19th Century AD",
      B: "In 1969",
      C: "After the abolition of State Shinto in 1945",
      D: "During ancient times",
    },
    answer: "A",
  },
  {
    question: "What was the main concern of Sect Shinto?",
    options: {
      A: "Political creation",
      B: "Human welfare in the present earthly life",
      C: "The performance of rites on behalf of imperial ancestors",
      D: "Purification ceremonies",
    },
    answer: "B",
  },
  {
    question: "What was the purpose of State Shinto?",
    options: {
      A: "To promote human welfare in this life",
      B: "To perform rites for the imperial ancestors",
      C: "To be a political creation with the aim of combining Shrine Shinto with the Shinto of the imperial house",
      D: "To abolish other forms of Shinto",
    },
    answer: "C",
  },
  {
    question: "When was State Shinto abolished?",
    options: {
      A: "1945",
      B: "The 19th Century",
      C: "1969",
      D: "Before the Allied Commanders arrived",
    },
    answer: "A",
  },
  {
    question:
      "The text states that the rituals of the Shinto of the Imperial House were not open to whom?",
    options: {
      A: "Foreigners",
      B: "The emperor",
      C: "Imperial ancestors",
      D: "The public",
    },
    answer: "D",
  },
  {
    question:
      "Which type of Shinto describes the mixture of superstition and magic common among people?",
    options: {
      A: "Shrine Shinto",
      B: "Folk Shinto",
      C: "State Shinto",
  ...
  {
    question:
      "What is one characteristic of the emperor's role in the Shinto of the Imperial House?",
    options: {
      A: "He performs rites on behalf of the imperial ancestors.",
      B: "He oversees the purification ceremonies.",
      C: "He is considered a 'Kami'.",
      D: "He is the head of all shrines.",
    },
    answer: "A",
  },
  {
    question:
      "The text mentions that 'most Japanese' accept what kind of Shinto customs?",
    options: {
      A: "State Shinto",
      B: "Sect Shinto",
      C: "Folk Shinto",
  ...
  {
    question:
      "What is the central philosophical concept of Taoism regarding human interaction with the natural order?",
    options: {
      A: "Active resistance to natural forces",
      B: "Complete withdrawal from all societal structures",
      C: "Harmonious non-interference with Tao's flow",
      D: "Strict adherence to ritualistic practices",
    },
    answer: "C",
  },
  {
    question:
      "Approximately when was Lao-Tzu, the founder of Taoism, believed to have been born?",
    options: {
      A: "800 BC",
      B: "600 BC",
      C: "400 BC",
  ...
  {
    question: "What was Lao-Tzu's occupation before founding Taoism?",
    options: {
      A: "Royal librarian of the Choun dynasty",
  ...
  {
    question: "What is the meaning of 'Tao Te Ching'?",
    options: {
      A: "The Book of Immortality",
      B: "The Way and Its Power",
      C: "The Path to Enlightenment",
      D: "The Sacred Rituals",
    },
    answer: "B",
  },
  {
    question: "Which of these is NOT a translation of the word 'Tao'?",
    options: {
      A: "Ultimate Reality",
      B: "The driving force of nature",
      C: "The path to political power",
      D: "The way man should live",
    },
    answer: "C",
  },
  {
    question: "What does 'Te' represent in Taoist philosophy?",
    options: {
      A: "The power of virtue",
      B: "The cycle of reincarnation",
      C: "The hierarchy of gods",
      D: "The art of governance",
    },
    answer: "A",
  },
  {
    question: "What distinguishes philosophical Taoism from popular Taoism?",
    options: {
      A: "Its focus on temple rituals",
      B: "Its rejection of all written texts",
      C: "Its appeal to mystical intellectuals",
      D: "Its worship of multiple deities",
    },
    answer: "C",
  },
  {
    question:
      "What is the primary distinction between Theravada and Mahayana Buddhism regarding the Buddha's nature?",
    options: {
      A: "Theravada sees Buddha as divine; Mahayana as human",
      B: "Theravada sees Buddha as human; Mahayana as superhuman",
      C: "Both view Buddha as purely symbolic",
      D: "Neither recognizes Buddha's historical existence",
    },
    answer: "B",
  },
  {
    question: "What is Zen Buddhism's view on expressing its doctrine?",
    options: {
      A: "It must be codified in precise scriptures",
      B: "It can only be felt, not expressed verbally",
      C: "It should be taught through elaborate rituals",
      D: "It requires academic theological training",
    },
    answer: "B",
  },
  {
    question: "What legendary event is considered the origin of Zen Buddhism?",
    options: {
      A: "Buddha's fire sermon",
      B: "Buddha's flower sermon",
      C: "Buddha's water miracle",
      D: "Buddha's diamond throne meditation",
    },
    answer: "B",
  },
  {
    question:
      "How does Mahayana Buddhism differ from Theravada regarding salvation?",
    options: {
      A: "Mahayana rejects the possibility of universal salvation",
      B: "Mahayana believes all can be saved through compassion",
      C: "Theravada emphasizes collective salvation",
      D: "Both share identical soteriological views",
    },
    answer: "B",
  },
  {
    question: "What is the Theravadin view on attaining Nirvana?",
    options: {
      A: "Requires divine intervention",
      B: "Achievable only through intense self-effort",
      C: "Automatic upon death",
      D: "Granted through priestly sacraments",
    },
    answer: "B",
  },
  {
    question: "Which country is the birthplace of Zen Buddhism?",
    options: {
      A: "India",
      B: "China",
      C: "Japan",
  ...
  {
    question:
      "What aspect of Zen Buddhism has particularly influenced Western thinkers?",
    options: {
      A: "Its political structures",
      B: "Its artistic traditions",
      C: "Its emphasis on inexpressible enlightenment",
      D: "Its medical practices",
    },
    answer: "C",
  },
  {
    question: "What is the primary concern of popular Taoism?",
    options: {
      A: "Political governance",
      B: "Quest for immortality",
  ...
  {
    question: "Which practice is NOT associated with popular Taoist priests?",
    options: {
      A: "Exorcism",
      B: "Disease cures",
      C: "Astronomical research",
      D: "Magic rites",
    },
    answer: "C",
  },
  {
    question: "What concept did popular Taoism borrow from Mahayana Buddhism?",
    options: {
  ...
  {
    question: "How many 'Gem' spirits are central to popular Taoist worship?",
    options: {
      A: "Three",
      B: "Five",
      C: "Eight",
  ...
  {
    question: "What trinity concept appears in popular Taoism?",
    options: {
      A: "Parallel to Christian Trinity",
      B: "Based on Hindu Trimurti",
      C: "Derived from Greek philosophy",
      D: "Copied from Egyptian gods",
    },
    answer: "A",
  },
  {
    question:
      "What supernatural power does the Tao Te Ching supposedly possess?",
    options: {
      A: "Weather control",
      B: "Magic powers",
      C: "Time manipulation",
  ...
  {
    question: "Which characteristic distinguishes popular Taoist ceremonies?",
    options: {
      A: "Silent meditation",
      B: "Noisy rituals",
      C: "Solo practitioners",
      D: "Animal sacrifices",
    },
    answer: "B",
  },
  {
    question:
      "What are the two extremes the Buddha warned against in his first sermon?",
    options: {
      A: "Wealth and poverty",
      B: "Devotion to passion and self-mortification",
      C: "Urban and rural lifestyles",
      D: "Theism and atheism",
    },
    answer: "B",
  },
  {
    question: "What does 'Anicca' fundamentally express in Buddhist doctrine?",
    options: {
      A: "Permanent soul",
  ...
  {
    question: "Which concept is NOT part of the Five Skandhas?",
    options: {
      A: "Rupa (body)",
      B: "Vedana (feeling)",
      C: "Dharma (duty)",
      D: "Vinnana (consciousness)",
    },
    answer: "C",
  },
  {
    question: "What causes suffering according to the Second Noble Truth?",
    options: {
      A: "Divine punishment",
      B: "Tanha (craving/desire)",
      C: "Social inequality",
      D: "Physical labor",
    },
    answer: "B",
  ...
  {
    question: "Which step comes FIRST in the Noble Eightfold Path?",
    options: {
      A: "Right Livelihood",
      B: "Right View",
  ...
  {
    question: "What is the ultimate purpose of following the Eightfold Path?",
    options: {
      A: "Political power",
      B: "Entry into Nirvana",
  ...
  {
    question: "Which precept prohibits Buddhist monks from eating after noon?",
    options: {
      A: "Fourth",
      B: "Sixth",
      C: "Eighth",
  ...
  {
    question: "What does the doctrine of 'Anatta' fundamentally deny?",
    options: {
      A: "The existence of suffering",
      B: "The concept of an eternal soul",
      C: "The possibility of enlightenment",
      D: "The value of meditation",
    },
    answer: "B",
  },
  {
    question: "Which component is NOT among the Five Skandhas?",
    options: {
      A: "Sankhara (mental processes)",
      B: "Maya (illusion)",
      C: "Sunna (ideas)",
      D: "Rupa (body)",
    },
  ...
  {
    question: "How does Anatta differ fundamentally from Hindu Atman?",
    options: {
      A: "Atman is eternal while Anatta denies permanence",
      B: "Both concepts are identical",
      C: "Atman is physical while Anatta is mental",
      D: "Anatta accepts divine essence",
    },
    answer: "A",
  },
  {
    question:
      "What is the danger in shifting from 'desiring to live' to 'desiring to die'?",
    options: {
      A: "Both extremes cause suffering",
      B: "It violates civil laws",
      C: "It angers the gods",
      D: "It prevents meditation",
    },
    answer: "A",
  },
  {
    question: "Which term describes the Buddhist concept of suffering?",
    options: {
      A: "Dukkha",
      B: "Karma",
      C: "Dharma",
  ...
  {
    question: "What biological concept parallels Buddhist 'Anicca'?",
    options: {
      A: "Genetic mutation",
  ...
  {
    question: "Which Hindu concept is analogous to Buddhist Samsara?",
    options: {
      A: "Moksha",
      B: "The wheel of rebirth",
      C: "Yoga discipline",
      D: "Caste duties",
    },
    answer: "B",
  ...
  {
    question:
      "According to the text, why did the government of Japan in the twentieth century decide to compel people to participate in Shinto ceremonies?",
    options: {
      A: "As a form of religious persecution",
      B: "As an act of patriotism",
      C: "To abolish Shinto completely",
      D: "To revive an ancient tradition",
    },
    answer: "B",
  },
  {
    question: "What happened to Shintoism after the defeat of Japan in 1945?",
    options: {
      A: "It was abolished by the occupying Allied Forces but later revived.",
      B: "It was made the official religion of Japan.",
      C: "It was combined with Buddhism and Confucianism.",
      D: "It became a religion exclusively for the emperor.",
    },
    answer: "A",
  },
  {
    question:
      "According to the scholar Motoori Norinaga, what is the meaning of the term 'Kami'?",
    options: {
      A: "It refers only to the deities of heaven and earth.",
      B: "It includes spirits of shrines and human beings.",
      C: "It is an outdated term with no clear meaning.",
      D: "It refers exclusively to spiritual mediums and shamans.",
    },
    answer: "B",
  },
  {
    question:
      "The text mentions that adherents of other religions, specifically which group, faced persecution in Japan?",
    options: {
      A: "Buddhists",
      B: "Confucianists",
      C: "Shamans",
  ...
  {
    question:
      "The text implies that the concept of 'Kami' has been difficult for adherents to explain. What does it say about this?",
    options: {
      A: "Scholars have never been able to define the term.",
      B: "The concept has not been easy to explain.",
      C: "The term has been misunderstood by many.",
      D: "Only Motoori Norinaga understood the term.",
    },
    answer: "B",
  },
  {
    question:
      "The text states that Shintoism got almost mixed up with which other religion?",
    options: {
      A: "Christianity",
      B: "Confucianism",
      C: "Buddhism",
  ...
  {
    question: "When did the persecution of other religions occur?",
    options: {
      A: "In ancient times",
      B: "During the 20th century",
      C: "During the 2nd World War",
      D: "After 1945",
    },
    answer: "C",
  },
  {
    question:
      "According to the text, what is a key characteristic of things that are called 'Kami'?",
    options: {
      A: "They are thought of as absolute supernatural beings.",
      B: "They possess superior power or were awe-inspiring.",
      C: "They are only things that are alive.",
      D: "They must have human-like qualities.",
    },
    answer: "B",
  },
  {
    question:
      "The text states that the Shinto religion is polytheistic. What does this mean?",
    options: {
      A: "People worship a single god.",
      B: "People worship spirits of the dead.",
      C: "People worship many gods.",
      D: "People worship only the sun-goddess.",
    },
    answer: "C",
  },
  {
    question: "Why was it not unusual to call an emperor a 'Kami'?",
    options: {
      A: "Because the emperor had a spiritual nature.",
      B: "Because the emperor was considered a god.",
      C: "Because 'Kami' can be any office that commands reverence.",
      D: "Because the emperor's life came from the gods.",
    },
    answer: "C",
  },
  {
    question:
      "The text lists several objects that can be considered 'Kami'. Which of the following is NOT on the list?",
    options: {
      A: "Birds and beasts",
  ...
  {
    question:
      "What is the belief about man in the teachings of the Shinto religion?",
    options: {
      A: "Man is a child of 'Kami'.",
      B: "Man is a superior being to 'Kami'.",
      C: "Man can become a god through purification.",
      D: "Man's life has no connection to the gods.",
    },
    answer: "A",
  },
  {
    question: "In ancient usage, what was considered 'Kami'?",
    options: {
      A: "Anything outside the ordinary or possessing superior power.",
      B: "Only the sun-goddess.",
      C: "Only the spirits of the dead.",
      D: "The sacred articles of the emperor.",
    },
    answer: "A",
  },
  {
    question:
      "The text notes that Shinto deities are not thought of as what, unlike in some other religions?",
    options: {
      A: "Spirits of nature",
      B: "Absolute supernatural beings",
      C: "Gods with superior power",
      D: "Entities that are to be worshipped",
    },
    answer: "B",
  },
  {
    question:
      "According to the text, what was the primary purpose of worshipping 'Kami' in the earliest times?",
    options: {
      A: "To gain spiritual enlightenment",
      B: "To usher in prosperity among the people",
      C: "To worship the sun-goddess Amatasuru Omikami",
      D: "To consult a shaman or spirit medium",
    },
    answer: "B",
  },
  {
    question: "The text concludes that Shintoism is also a religion of what?",
    options: {
      A: "Spiritualism",
      B: "Patriotism",
      C: "Agriculture",
  ...
  {
    question:
      "In the 4th Century AD, which clan adopted Shintoism as the national religion?",
    options: {
      A: "The Motoori clan",
      B: "The Yamado clan",
      C: "The Mayumi clan",
  ...
  {
    question:
      "What was the name of the sun-goddess that Shintoism was centered on?",
    options: {
      A: "Amaterasu Omikami",
      B: "Amatasuru Omikami",
      C: "Amaterasu Jimmu",
  ...
  {
    question:
      "What were the three sacred articles that became the official regalia of the emperor?",
    options: {
      A: "The mirror, the jewel, and the sword",
      B: "The sword, the shield, and the crown",
      C: "The scroll, the scepter, and the mirror",
      D: "The rice bowl, the glass of water, and the sword",
    },
    answer: "A",
  },
  {
    question: "The sun-goddess was regarded as the guardian of what?",
    options: {
      A: "The emperor",
      B: "The ruling family",
      C: "The mirror, the sword, and the jewel",
      D: "Agriculture",
    },
    answer: "D",
  },
  {
    question:
      "According to the text, what did emperor Jimmu and his grandson receive from the goddess?",
    options: {
      A: "A new clan name",
      B: "The title of 'Kami'",
      C: "Three sacred articles",
      D: "The national religion",
    },
    answer: "C",
  },
  {
    question:
      "Shintoism is popularly described as the Japanese search for what?",
    options: {
      A: "God",
      B: "Prosperity",
      C: "The Way",
  ...
  {
    question:
      "What is the meaning of the two Chinese characters that make up the word 'Shinto'?",
    options: {
      A: "Holy Way",
      B: "God Way",
      C: "Sacred Path",
  ...
  {
    question:
      "The text states that the formation of Shintoism is almost identical with what?",
    options: {
      A: "The introduction of Buddhism",
      B: "The Japanese search for God",
      C: "The Japanese ethnic culture",
      D: "The worship of Kami",
    },
    answer: "C",
  },
  {
    question:
      "What did a Japanese person named Mayumi do every morning before breakfast as an act of worship?",
    options: {
      A: "He consulted a shaman.",
      B: "He brought a bowl of rice to the gods.",
      C: "He performed a purification procedure with salt.",
      D: "He received three sacred articles from the goddess.",
    },
    answer: "B",
  },
  {
    question:
      "The text says that Shinto relates to the Japanese way of life and tradition. What is its relationship with other religions?",
    options: {
      A: "All Japanese people practice Shinto.",
      B: "Other religions like Buddhism and Christianity also exist in Japan.",
      C: "Shinto is a mix of other religions.",
      D: "Shintoism abolished all other religions.",
    },
    answer: "B",
  },
  {
    question:
      "What does the first Chinese character, 'shin', mean in the word 'Shinto'?",
    options: {
      A: "Way",
      B: "God or gods",
      C: "Japan",
  ...
  {
    question:
      "What does the second Chinese character, 'to', mean in the word 'Shinto'?",
    options: {
      A: "Gods",
      B: "Way",
      C: "Japan",
  ...
  {
    question:
      "What is the primary means to achieve realization of Brahman according to Hindu scriptures?",
    options: {
      A: "Through elaborate temple rituals",
      B: "By leading a disciplined life of non-violence and detachment",
      C: "Through political leadership",
      D: "By memorizing all Vedas",
    },
    answer: "B",
  },
  {
    question: "Which Hindu scripture represents the 'way of action'?",
    options: {
      A: "Upanishads",
      B: "Bhagavad Gita",
      C: "Vedas",
  ...
  {
    question:
      "What determines one's next incarnation according to the Upanishads?",
    options: {
      A: "Random selection by gods",
      B: "The quality of one's current life (karma)",
      C: "Family wealth",
      D: "Caste at birth",
    },
    answer: "B",
  ...
  {
    question: "Which Hindu text harmonizes action, knowledge, and devotion?",
    options: {
      A: "Rig Veda",
      B: "Laws of Manu",
      C: "Bhagavad Gita",
  ...
  {
    question:
      "What is the origin of the caste system according to Vedic tradition?",
    options: {
      A: "Divine creation from Purusha's body parts",
  ...
  {
    question:
      "Which group was responsible for teaching the Vedas according to the Laws of Manu?",
    options: {
      A: "Kshatriyas",
      B: "Vaishyas",
      C: "Shudras",
  ...
  {
    question:
      "What was the historical basis for caste distinction according to early Aryans?",
    options: {
  ...
  {
    question:
      "What happens to the soul (Atman) upon achieving realization of Brahman?",
    options: {
      A: "It becomes a deity",
      B: "It escapes the cycle of rebirth",
      C: "It gains physical immortality",
      D: "It merges with nature",
    },
    answer: "B",
  },
  {
    question: "Which path to truth emphasizes personal devotion to a deity?",
    options: {
      A: "Way of Action",
      B: "Way of Knowledge",
      C: "Way of Devotion",
  ...
  {
    question: "What was the original term for outcastes in Hinduism?",
    options: {
      A: "Dalits",
      B: "Untouchables",
      C: "Adivasis",
  ...
  {
    question:
      "Which Hindu doctrine teaches that Atman and Brahman are identical?",
    options: {
      A: "Karma",
      B: "Dharma",
      C: "Advaita Vedanta",
  ...
  {
    question:
      "What was the primary duty of Kshatriyas according to the Laws of Manu?",
    options: {
      A: "Agricultural work",
  ...
  {
    question:
      "Which scripture introduced the concept of Samsara (transmigration of souls)?",
    options: {
      A: "Vedas",
      B: "Upanishads",
      C: "Puranas",
  ...
  {
    question:
      "What was the consequence of inter-caste marriage in traditional Hinduism?",
    options: {
      A: "Promotion to higher caste",
      B: "Loss of caste status",
      C: "Monetary fine",
  ...
  {
    question:
      "Which Hindu concept emphasizes non-violence toward all life forms?",
    options: {
      A: "Dharma",
      B: "Ahimsa",
      C: "Maya",
  ...
  {
    question: "What is the Rig-Vedic Hymn about the origin of castes called?",
    options: {
      A: "Hymn of Creation",
      B: "Hymn of Man",
      C: "Hymn of Sacrifice",
  ...
  {
    question:
      "Which group was exclusively assigned to serve the other three castes?",
    options: {
      A: "Brahmins",
      B: "Kshatriyas",
      C: "Vaishyas",
  ...
  {
    question: "What aspect of Hinduism demonstrates its philosophical nature?",
    options: {
      A: "Temple architecture",
      B: "Multiple paths to truth",
      C: "Festival celebrations",
      D: "Pilgrimage sites",
    },
    answer: "B",
  },
  {
    question:
      "Which Hindu text codified the social and religious foundations of castes?",
    options: {
      A: "Bhagavad Gita (3rd Century BC)",
      B: "Laws of Manu (3rd Century AD)",
      C: "Arthashastra (300 BC)",
      D: "Yoga Sutras (200 BC)",
    },
    answer: "B",
  },
  {
    question:
      "What is the ultimate goal of the 'way of knowledge' in Hinduism?",
    options: {
      A: "Academic scholarship",
      B: "Realization of Brahman",
      C: "Memorization of scriptures",
      D: "Astrological proficiency",
    },
    answer: "B",
  },
  {
    question: "Which Hindu concept is described as 'all-permeating'?",
    options: {
      A: "Karma",
      B: "Brahman",
      C: "Maya",
  ...
  {
    question: "What was the original purpose of Vedic sacrifices?",
    options: {
      A: "To attain political power",
      B: "To gain agricultural success and long life",
  ...
  {
    question: "Which Hindu path could be practiced by people of low caste?",
    options: {
      A: "Way of Action (Vedas)",
      B: "Way of Knowledge (Upanishads)",
      C: "Way of Devotion (Bhakti)",
      D: "All of the above",
    },
    answer: "C",
  },
  {
    question:
      "What was the geographical origin of the Aryan invaders who influenced the caste system?",
    options: {
  ...
  {
    question: "Which Hindu concept refers to one's caste duties?",
    options: {
      A: "Karma",
      B: "Dharma",
      C: "Moksha",
  ...
  {
    question: "What was unique about the performance of Vedic sacrifices?",
    options: {
      A: "Conducted in temples",
      B: "Performed only by women",
      C: "Held in open around sacred fire",
      D: "Required animal slaughter",
    },
    answer: "C",
  },
  {
    question: "Which Hindu scripture significantly influenced Buddhism?",
    options: {
      A: "Vedas",
      B: "Upanishads",
      C: "Puranas",
  ...
  {
    question: "What was the original social function of the Vaishya caste?",
    options: {
      A: "Priestly duties",
      B: "Military service",
  ...
  {
    question: "What is the caste system described as being the outcome of?",
    options: {
      A: "The sacrifice of Purusha",
      B: "The law of MANU",
      C: "The work of Brahmins and Kshatriyas",
      D: "The Hymn of Man",
    },
    answer: "A",
  },
  {
    question: "What does the text say about the duties of a caste?",
    options: {
      A: "They are determined by personal choice.",
      B: "They are hereditary.",
      C: "They are the same for all castes.",
      D: "They are outlined by the law of MANU.",
    },
    answer: "B",
  },
  {
    question:
      "According to the text, what was the founder of Buddhism, Gotama, by caste?",
    options: {
      A: "Brahmin",
      B: "Kshatriya",
      C: "Sudra",
  ...
  {
    question: "What were the 'outcastes' used to be called?",
    options: {
      A: "Brahmins",
      B: "Kshatriyas",
      C: "Untouchables",
  ...
  {
    question: "What was the duty of the Brahmins?",
    options: {
      A: "To protect the people as warriors",
      B: "To offer sacrifices and lead respectable lives",
      C: "To teach the Vedas and to be priests",
      D: "To perform rites for the dead",
    },
    answer: "C",
  },
  {
    question: "What was the duty of the Kshatriyas?",
    options: {
      A: "To teach the Vedas",
      B: "To be priests",
      C: "To protect the people as warriors",
      D: "To be untouchables",
    },
    answer: "C",
  },
  {
    question: "What does the text say about the hereditary nature of a caste?",
    options: {
      A: "A person can marry outside of their caste.",
      B: "A person of one caste should not marry a person of another caste.",
      C: "A person can choose their caste.",
      D: "A person can be born into a caste but is not bound by it.",
    },
    answer: "B",
  },
  {
    question: "How is Hinduism described in the introduction?",
    options: {
      A: "The search for liberation and fusion with Bramah",
      B: "The search for a single, personal God",
      C: "A brand of religion with fixed doctrines",
      D: "The search for a way to define a Hindu",
    },
    answer: "A",
  },
  {
    question: "What is a common religious custom performed in the morning?",
    options: {
      A: "Making offerings of food to a deity",
      B: "Bathing in a nearby river or stream",
      C: "Praying to the god Ganesa",
      D: "Washing the idol with red and yellow powder",
    },
    answer: "B",
  },
  {
  ...
  {
    question: "What does the word 'Hinduism' mean, according to the text?",
    options: {
      A: "A word with little meaning",
      B: "Indian Religion",
      C: "The way of life",
      D: "The way of the gods",
    },
  ...
  {
    question:
      "The text states that nearly every home has a favorite corner for the worship of which god?",
    options: {
      A: "Krishna",
      B: "Rama",
      C: "Ganesa",
  ...
  {
    question: "Who can make offerings of flowers and food to a local temple?",
    options: {
      A: "Only priests",
      B: "Only Brahmins",
      C: "Only those who have bathed",
      D: "People who have not eaten",
    },
    answer: "D",
  },
  {
    question: "The text says Hinduism is a collection of what?",
    options: {
      A: "Fixed religious dogmas",
      B: "Ways of life and tradition",
      C: "Many kinds of religious practices",
      D: "Hereditary duties and customs",
    },
    answer: "C",
  },
  {
    question:
      "What is the relationship between the soul (Ataman) and the ultimate reality (Bramah)?",
    options: {
      A: "They are opposed to each other.",
      B: "They are literally one and the same.",
      C: "The soul is an extension of Bramah but not identical.",
      D: "The soul is created by Bramah.",
    },
    answer: "B",
  },
  {
    question:
      "What is the ultimate fate of someone who attains the realization that the soul and Bramah are one?",
    options: {
      A: "They are reincarnated into a higher caste.",
      B: "They escape the wheel of death and are absorbed into Bramah.",
      C: "They are forbidden to take their own life.",
      D: "They become a great saint.",
    },
    answer: "B",
  },
  {
    question:
      "Which scripture is mentioned as representing 'The way of devotion (Bhakti)'?",
    options: {
      A: "The Vedas",
      B: "The Upanishads",
      C: "The Bhagavad Gita",
  ...
  {
    question: "According to the text, who can offer devotion to the deity?",
    options: {
      A: "Only priests of the highest caste",
      B: "Only people who have attained spiritual realization",
      C: "Anyone, even people of low caste",
      D: "Only men, not women",
    },
    answer: "C",
  },
  {
    question: "How is devotion (Bhakti) to be offered?",
    options: {
      A: "Through ritual and sacrifice",
      B: "With sincerity from the heart",
      C: "Through the reading of scriptures",
      D: "By performing duties according to one's caste",
    },
    answer: "B",
  },
  {
    question:
      "The text mentions that the beginning of Hinduism as we know it treats the ultimate reality as what?",
    options: {
      A: "A single, unchanging god",
      B: "Impersonal",
      C: "Personal",
      D: "A collection of many gods",
    },
    answer: "C",
  },
  {
    question:
      "The coalescing of Aryan deities is described as an indication of what?",
    options: {
      A: "The resurgence of pre-Aryan ideas",
      B: "The beginning of the caste system",
      C: "The establishment of a monotheistic religion",
      D: "The end of the Vedic period",
    },
    answer: "A",
  },
  {
    question:
      "What is the collective belief of Hinduism regarding the material universe?",
    options: {
      A: "It is real and does not change.",
      B: "It is merely apparent, not a reality.",
      C: "It is the source of all spiritual power.",
      D: "It is the ultimate reality itself.",
    },
    answer: "B",
  },
  {
    question: "What is the word 'Hindu' derived from, according to the text?",
    options: {
      A: "A Sanskrit word for 'god'",
      B: "A Greek word for 'religion'",
      C: "The Indus Valley in North-West India",
      D: "The Ganges River",
    },
    answer: "C",
  },
  {
    question: "How old is Hinduism believed to be?",
    options: {
      A: "Approximately 1,000 years",
      B: "Over 3,500 years",
      C: "Exactly 1,200 years",
      D: "Only a few hundred years",
    },
    answer: "B",
  },
  {
    question:
      "What does the text say about the constant change or evolution in Hinduism?",
    options: {
      A: "Hindus believe nothing is permanent.",
      B: "Hindus believe only the gods are permanent.",
      C: "Hindus believe in a single, unchanging truth.",
      D: "Hindus believe that change is an illusion.",
    },
    answer: "A",
  },
  {
    question:
      "What is the belief about where a soul may be found, according to the text?",
    options: {
      A: "Only in humans",
      B: "Only in animals and humans",
      C: "In plants, animals, or human beings",
      D: "Only in deities",
    },
    answer: "C",
  },
  {
    question: "What is a 'dogma' according to the text?",
    options: {
      A: "A system of beliefs put forward by an authority in a religion",
      B: "A form of prayer",
      C: "A religious duty",
      D: "A way of life",
    },
  ...
  {
    question:
      "The text states that Hinduism has a large religious group. How many followers did it have in India as of 1990?",
    options: {
      A: "Over 800 million",
      B: "Over 1.5 million",
      C: "700 million",
  ...
  {
    question: "What is the concept of 'caste' based on, according to the text?",
    options: {
  ...
  {
    question:
      "When did the Aryan invaders arrive in the region, according to the text?",
    options: {
      A: "Between 1500 and 1200 BC",
      B: "In the 3rd Century AD",
      C: "In 1990 AD",
      D: "During the Vedic period",
    },
    answer: "A",
  },
  {
    question: "What is the origin of the term 'caste' believed to be?",
    options: {
      A: "A distinction based on wealth",
      B: "A distinction based on color",
      C: "A distinction based on birthplace",
      D: "A distinction based on occupation",
    },
    answer: "B",
  },
  {
    question: "Who is 'Purusha' in the Brahmanical religion?",
    options: {
      A: "The founder of Buddhism",
      B: "The creator of the caste system",
      C: "The first man created by Bramah",
      D: "The sun god",
    },
    answer: "C",
  },
  {
    question:
      "What were the four classes that emerged during the Vedic period called?",
    options: {
      A: "The four groups",
      B: "The four Varnas",
      C: "The four castes",
  ...
  {
    question:
      "The text states that Hinduism is a 'philosophical religion'. What does this imply?",
    options: {
      A: "It is based on the teachings of a single philosopher.",
      B: "It is a collection of fixed dogmas.",
      C: "It is based on a system of fixed social classes.",
      D: "It has a deep intellectual tradition and doctrines.",
    },
    answer: "D",
  },
  {
    question: "What is the basis of Hinduism, according to the text?",
    options: {
      A: "Being born into a caste",
      B: "Adhering to a philosophical system",
      C: "Worshipping Bramah",
      D: "Following the Vedas",
    },
    answer: "A",
  },
  {
    question: "What is the concept of 'Ahimsa' as mentioned in the text?",
    options: {
      A: "Leading a good life",
      B: "Non-violence",
      C: "Detachment from the world",
      D: "Sacrifice",
    },
    answer: "B",
  },
  {
    question: "What do the Vedas represent?",
    options: {
      A: "The way of knowledge",
      B: "The way of devotion",
      C: "The way of action",
      D: "The way of non-violence",
    },
    answer: "C",
  },
  {
    question: "What do the Upanishads represent?",
    options: {
      A: "The way of knowledge",
      B: "The way of action",
  ...
  {
    question: "What does 'Samsara' refer to?",
    options: {
      A: "Transmigration of souls",
      B: "A holy scripture",
  ...
  {
    question:
      "According to the Upanishads, what determines the kind of person you will be in your next incarnation?",
    options: {
      A: "The sacrifices you perform",
      B: "The kind of life you lead now",
      C: "The amount of knowledge you have",
      D: "The gods you worship",
    },
    answer: "B",
  },
  {
    question: "When is sacrifice performed according to the Vedas?",
    options: {
      A: "In temples",
      B: "In the open, round the sacred fire",
      C: "Only by Brahmin priests",
      D: "After achieving long life",
    },
    answer: "B",
  },
  {
    question:
      "What is the term for the impersonal unchanging reality that is to be found in all things?",
    options: {
      A: "Moksha",
      B: "Atman",
      C: "Bramah",
  ...
  {
    question:
      "How do some Hindus view the numerous gods and goddesses, according to the text?",
    options: {
      A: "As different ways of looking at one reality",
      B: "As separate and distinct divine beings",
      C: "As beings to be worshiped to distract from the one reality",
      D: "As equal to the ultimate reality",
    },
    answer: "A",
  },
  {
    question: "What is the Hindu ideal mentioned in the text?",
    options: {
      A: "To be born into a good caste",
      B: "To be absorbed into God and quit the world of impermanence",
      C: "To live a long life with future happiness",
      D: "To perform sacrifices correctly",
    },
    answer: "B",
  },
  {
    question:
      "What is the meaning of the word 'neuter' as applied to 'Bramah'?",
    options: {
      A: "Neither male nor female nor 'it'",
      B: "Both male and female",
      C: "Neither male nor female but 'it'",
      D: "Refers to a spiritual force without a body",
    },
    answer: "C",
  },
  {
    question: "What is 'Moksha' also known as?",
    options: {
      A: "Detachment from the world",
      B: "Transmigration of souls",
      C: "Release or liberation from impermanence",
      D: "Sacrifice",
    },
    answer: "C",
  },
  {
    question: "The text states that Hindus believe there is only one what?",
    options: {
      A: "Sacred text",
      B: "God",
      C: "Way of life",
  ...
  {
    question: "How do some modern Hindus talk of Bramah?",
    options: {
      A: "As the ultimate reality",
      B: "As the personal supreme reality",
      C: "As a god among many",
      D: "As the creator of the first man",
    },
    answer: "B",
  },
];
...
export default function CBTApp() {
  ...
  useEffect(() => {
    if (progressBarRef.current) {
      const progress =
        (Object.keys(userAnswers).length / shuffledQuestions.length) * 100;
  ...
  const getScore = () => {
    return shuffledQuestions.reduce(
      (score, q, idx) => (q.answer === userAnswers[idx] ? score + 1 : score),
      0
    );
  };
          ...
          <div className="p-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Learn with instant feedback. No time pressure. Perfect for
                mastering concepts.
              </p>
            </div>
            ...
            <div
              ...
              onClick={() => {
                const mins = parseInt(
                  prompt(
                    "Enter test duration in minutes (recommended 5 minutes):",
                    "5"
                  ),
                  10
                );
            ...
            >
              ...
              <p className="text-gray-600">
                Timed test environment. Simulates real exam conditions.
                Challenge yourself!
              </p>
            </div>
          </div>
              ...
              {mode === "real" && (
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-blue-600">
                    {formatTime(shuffledQuestions.length * 60 - timeLeft)}
                  </span>
                </div>
              )}
            </div>
            ...
            {Object.entries(currentQuestion.options).map(([key, val]) => {
              ...
              return (
                <div
                  ...
                  onClick={() =>
                    !userAnswers[currentIndex] && handleAnswer(key)
                  }
                >
                  <div
            ...
            <div className="mt-4 text-center text-sm text-gray-500">
              {Object.keys(userAnswers).length === totalQuestions
                ...
                : `${
                    ...
                    totalQuestions - Object.keys(userAnswers).length !== 1
                      ? "s"
                      : ""
                  } remaining`}
            </div>
